...
contract ReporterTokenSale is Ownable {
  ...
  uint256 public maxTokens = 40 * (10**6) * (10**decimals);

  // maximum amount of tokens
  uint256 public tokensForSale = 24 * (10**6) * (10**decimals);  // 24 Million Tokens for SALE
  ...
  function finishSale() public onlyOwner {
    ...
    // the token holders from now can trading with the tokens . We can not stoping 
    token.startTrading();
    SaleClosed();
  }
